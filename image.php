		...
		<div id="post-<?php the_ID(); ?>" <?php post_class('single post'); ?>>
			...
			<div class="post-inner">
				...
				<div class="post-meta-bottom">
					<ul>
						<li><?php _e('Uploaded by', 'ecards'); ?> <?php the_author_posts_link(); ?></p>
						...
						<li><?php _e('Resolution:', 'ecards'); ?> <?php echo $imageArray['1'] . 'x' . $imageArray['2'] . ' px'; ?></li>
					</ul>
					<div class="clear"></div>
	   	...
	   	<?php endwhile; else: ?>
			<p><?php _e('We could not find any posts that matched your query. Please try again.', 'ecards'); ?></p>
		<?php endif; ?>    
	</div> <!-- /post -->
</div> <!-- /content -->
