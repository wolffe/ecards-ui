	...
	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class('single'); ?>>
			...
			<?php elseif ( $post_format == 'gallery' ) : ?>
				<div class="featured-media">	
					<?php ecards_flexslider('post-image'); ?>
					<div class="clear"></div>
				</div> <!-- /featured-media -->
            ...
            <div class="post-inner">
				...
				<div class="post-meta-bottom">
					<?php 
                    $args = array(
                        'before'           => '<div class="clear"></div><p class="page-links"><span class="title">' . __( 'Pages:','ecards' ) . '</span>',
						'after'            => '</p>',
						'link_before'      => '<span>',
						'link_after'       => '</span>',
						'separator'        => '',
					...
					<ul>
						...
						<?php if (has_category()) : ?>
							<li class="post-categories"><?php _e('In','ecards'); ?> <?php the_category(', '); ?></li>
						<?php endif; ?>
						<?php if (has_tag()) : ?>
			...
			<div class="post-navigation">
				<?php
				if (!empty( $prev_post )): ?>
					<a class="post-nav-prev" title="<?php _e('Previous post', 'ecards'); echo ': ' . esc_attr( get_the_title($prev_post) ); ?>" href="<?php echo get_permalink( $prev_post->ID ); ?>">
						<p>&larr; <?php _e('Previous post', 'ecards'); ?></p>
					</a>
				<?php endif; ?>

				<?php
				if (!empty( $next_post )): ?>
					<a class="post-nav-next" title="<?php _e('Next post', 'ecards'); echo ': ' . esc_attr( get_the_title($next_post) ); ?>" href="<?php echo get_permalink( $next_post->ID ); ?>">					
						<p><?php _e('Next post', 'ecards'); ?> &rarr;</p>
					</a>
				<?php endif; ?>
